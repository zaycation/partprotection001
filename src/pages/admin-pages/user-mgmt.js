      ...
      <Row>
        <Col xs={12} sm={12} md={2} lg={2} xl={2} className="left-nav">
          ...
          >
            ...
            <Nav.Link eventKey="link-0" className="nav-link-txt" href="/admin-policy">
              <FaSearch size={24} color="#84909B" className="me-2" />
              Policy Lookup
            </Nav.Link>
            <Nav.Link
              eventKey="link-1"
              className="nav-link-txt left-nav-active" href="/admin-usermgmt"
            >
            ...
            <Nav.Link eventKey="link-4" className="nav-link-txt" href="/admin-sellermgmt">
              <FaSlidersH size={24} color="#84909B" className="me-2" />
              Seller Management
            </Nav.Link>
            <Nav.Link eventKey="link-5" className="nav-link-txt" href="/admin-functions">
              <FaChartBar size={24} color="#84909B" className="me-2" />
              Admin Functions
            </Nav.Link>
            <Nav.Link eventKey="link-6" className="nav-link-txt" href="/privacy-policy">
